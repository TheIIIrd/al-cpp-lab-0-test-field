...
void num_1 () {
    ...
    if ((X % 5 == 0 && (Y * Z) % 5 != 0) || (Y % 5 == 0 && (X * Z) % 5 != 0) || (Z % 5 == 0 && (Y * X) % 5 != 0)) {
...
Для пары удобно использовать тип std::pair, чтобы обратиться к первому элементу пары, нужно указать к 
переменной приписать .first, чтобы обратиться ко второму элементу - .second.
...
void num_2 () {
    ...
    if ((positionA.first != positionB.first || positionA.second != positionB.second) && 
       (positionA.first > 0 && positionA.first < 9 && positionA.second > 0 && positionA.second < 9 && 
       (positionB.first > 0 && positionB.first < 9 && positionB.second > 0 && positionB.second < 9))) {
        ...
        if (positionA.first == positionB.first || positionA.second == positionB.second) {
            ...
            cout << "угрожает полю [" << positionB.first << " ," << positionB.second << "]" << endl;
            ...
            cout << "[-] Ладья (" << positionA.first << ", " << positionA.second << ") ";
            cout << "не угрожает полю [" << positionB.first << " ," << positionB.second << "]" << endl;
        ...
        if (abs(positionA.first - positionB.first) <= 1 && abs(positionA.second - positionB.second) <= 1 && 
           (positionA.first != positionB.first && positionA.second != positionB.second)) {
            ...
            cout << "может переместиться на [" << positionB.first << " ," << positionB.second << "]" << endl;        
            ...
            cout << "[-] Король (" << positionA.first << ", " << positionA.second << ") ";
            cout << "не может переместиться на [" << positionB.first << " ," << positionB.second << "]" << endl;
        ...
        - когда она "бьет" фигуру или пешку соперника.
        */
        if ((positionA.second == 2 && (positionB.second == positionA.second + 2) && positionA.first == positionB.first) ||
           ((positionB.first == positionA.first + 1) && positionA.second == positionB.second)) {
        ...
        else if ((abs(positionA.first - positionB.first) == 1) && (abs(positionB.second - positionA.second) == 1)) {

            cout << "[+] Пешка (" << positionA.first << ", " << positionA.second << ") ";
            cout << "может переместиться на [" << positionB.first << " ," << positionB.second << "] если тут будет вражеская фигура" << endl;
